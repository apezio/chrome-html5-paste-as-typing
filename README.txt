...
5) Pin the extension Icon for this extenion (click Extensions icon in the browser window, and then toggle the 'Pin' icon).

USAGE
Paste: Option/Alt-Shift-v
Abort: Option/Alt-Shift-.
(uses Option on Mac, Alt on Windows)

Paste via Click:
* Click the Extension icon. This will immediately simulate keystrokes of the contents of the clipboard.  


NOTES
For Supermicro HTML5/iKVM the default pop-up window has a limited version of the Chrome menubar (so you can't view or click extension icons).  So, either use the keyboard shortcut (option-shift-v), or copy the URL of the current HTML5 page and paste it into a new tab or new window.  The new tab or window will have the full Chrome menubar.  
